...
`dropkit.contents` is a public site and research repository. The `agent-harness`
directory is an experimental, draft-first fixture; it is not a production ERP,
QMS, mail, or desktop automation connector.
