...
- 검토 기준일: 2026-09-21
- 저장소: `Hskim-droid/dropkit.contents`
...
| 설계 요구 | 구현 위치 | 검증 | 상태 |
| --- | --- | --- | --- |
| semantic browser discovery | `agent-harness/browser_probe.py` | `tests/test_browser_probe.py`, 3 variant | 완료 |
| backend-neutral observation/action/evidence | `agent-harness/surface_adapter.py` | `tests/test_surface_adapter.py` | 완료 |
| macOS AX / Windows UIA optional adapters | `agent-harness/native_adapters.py` | fake tree·permission·partial failure tests | 실제 호스트 전 검증 완료 |
